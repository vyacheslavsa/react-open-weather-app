...
const Home = () => {
    ...
    const localStoreLang = JSON.parse(localStorage.getItem('CURRENT_LANG'));
    ...
    const lang = localStoreLang || language;
    ...
    useEffect(() => {
        ...
        if (currentGEO) {
            dispatch(getDataCurrentWeather(currentGEO.lat, currentGEO.lon, lang));
